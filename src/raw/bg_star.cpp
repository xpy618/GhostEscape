...
void BgStar::render()
{
    ...
    Game::getInstance().drawPoints(star_far_, pos * scale_far_, color_far_);
    Game::getInstance().drawPoints(star_mid_, pos * scale_mid_, color_mid_);
    Game::getInstance().drawPoints(star_near_, pos * scale_near_, color_near_);
}
